...
A single file, front end only web app that acts as a directory of "verified" handmade/small businesses. It's built as one self-contained `index.html` with inline CSS and vanilla JavaScript.
## What it does
